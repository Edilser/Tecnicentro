  ...
  <div id="invoice-template" class="card-body">
      ...
      <div class="container w-100">
        <div class="row w-100 border">
          @foreach ($cotizacion->detalle as $detalle)
            @if ($detalle->tipo == 'REQUERIMIENTO')
              <div class="col w-100">
                <h4 class="text-danger text-center"><strong>Requerimiento</strong></h4>
          ...
          @endforeach
              <div class="col w-100">
                @foreach ($cotizacion->detalle as $detalle)
                  ...
                  <p><strong>Garantia </strong> {{$detalle->descripcion}}</p>
                  @elseif ($detalle->tipo == 'CALIDAD')
                  <p><strong>Calidad </strong> {{$detalle->descripcion}}</p>
                  @elseif ($detalle->tipo == 'TIEMPO')
                  <p><strong>Tiempo Entrega </strong> {{$detalle->descripcion}}</p>
                  @endif
                @endforeach
              </div>
        </div>
              ...
              <div class="col-12">
                  <div class="table-responsive">
                      <table class="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                              <th>SUB-TOTAL DE LA REPARACIÓN</th>
                              <td>{{$total}}</td>
                          </tr>
                          <tr>
                              <th>IVA</th>
