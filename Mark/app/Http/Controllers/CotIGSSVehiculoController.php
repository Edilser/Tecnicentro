...
class CotIGSSVehiculoController extends Controller
{
  ...
  public function store(Request $request) {
    ...
    if($request['nog']) {
      ...
      $CD->idCotizacionencabezado = $CE['id'];
      $CD->tipo = 'NOG';
      $CD->descripcion = $request['nog'];
      $CD->save();
    }

    if($request['requerimiento']) {
      $CD = new cotizaciondetalle;
      $CD->idCotizacionencabezado = $CE['id'];
      $CD->tipo = 'REQUERIMIENTO';
      $CD->descripcion = $request['requerimiento'];
      $CD->save();
    }
    ...
    if($request['calidad']) {
      ...
      $CD->idCotizacionencabezado = $CE['id'];
      $CD->tipo = 'CALIDAD';
      $CD->descripcion = $request['calidad'];
      $CD->save();
    }
    ...
    if($request['observaciones']) {
      $CD = new cotizaciondetalle;
      $CD->idCotizacionencabezado = $CE['id'];
      $CD->tipo = 'OBSERVACIONES';
      $CD->descripcion = $request['observaciones'];
      $CD->save();
    }

    return redirect ('cotizacion-vehiculo')->with('success', 'cotizacion guardada');
  ...
  public function search(Request $request) {
    ...
    return view('/cotizaciones/igssvehiculo/index', compact('cotizacion'));
  }
